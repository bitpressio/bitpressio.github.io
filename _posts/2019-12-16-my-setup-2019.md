...
While a bit on the expensive side, I prefer Google Cloud to host Docker containers in Kubernetes. I find Google Cloud a little more intuitive than AWS, and not having the manage Kubernetes myself is a huge win. Google cloud feels lightning fast, and I've got most of my environment automated with [Terraform by HashiCorp](https://www.terraform.io/).
